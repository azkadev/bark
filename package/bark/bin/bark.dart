...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name = "package:bark/bark.dart",
  }) async {
  ...
  Directory? base_directory_lib = (await getPackageDirectory(package_name: "package:bark/bark.dart"));
...
Global options:
  ...
  reload               Reload package bark.dart
...
""";
  ...
  if (command == "version") {
    print("bark version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
